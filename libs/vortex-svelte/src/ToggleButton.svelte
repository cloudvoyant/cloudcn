<!-- libs/vortex-svelte/src/ToggleButton.svelte -->
<!-- Closely based on: @ark-ui/svelte/toggle (Ark UI), mirrored from @cloudvoyant/vortex-react -->
<script lang="ts">
  import { ToggleRoot, type ToggleRootProps } from '@ark-ui/svelte/toggle';
  import { toggleButtonVariants, cn } from '@cloudvoyant/vortex-ui';
