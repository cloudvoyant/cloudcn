<!-- libs/vertex-svelte/src/code-block/CodeBlock.svelte -->
<!-- Closely based on: diffbook code-block family, rebuilt as a composable API, mirrored from @cloudvoyant/vertex-react -->
<script lang="ts">
