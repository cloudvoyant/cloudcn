<!-- libs/vortex-svelte/src/CopyButton.svelte -->
<!-- Closely based on: Shark UI clipboard (@ark-ui/svelte/clipboard), mirrored from @cloudvoyant/vortex-react -->
<script lang="ts">
  import {
    ClipboardRoot,
    ClipboardTrigger,
  ...
  import { clipboardTriggerBase, cn } from '@cloudvoyant/vortex-ui';
