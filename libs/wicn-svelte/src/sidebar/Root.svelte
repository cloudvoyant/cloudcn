<!-- libs/wicn-svelte/src/Sidebar.svelte -->
<!-- Source: @ark-ui/svelte/drawer (Ark UI), mirrored from wicn-react -->
<script lang="ts">
  import {
    DrawerRoot,
    DrawerBackdrop,
  ...
  import { SIDEBAR_WIDTH_MOBILE, sidebarStyles, cn } from 'wicn-core';
