<!-- libs/vortex-svelte/src/field/FieldSetLegend.svelte -->
<!-- Closely based on: Shark UI field (@ark-ui/svelte/fieldset), mirrored from @cloudvoyant/vortex-react -->
<script lang="ts">
  import { FieldsetLegend, type FieldsetLegendProps } from '@ark-ui/svelte/fieldset';
  import { fieldsetLegendBase, cn } from '@cloudvoyant/vortex-ui';
