<!-- libs/vertex-svelte/src/navbar/NavbarMobileOverlay.svelte -->
<!-- Source: @cloudvoyant/vertex-react navbar mobile (Ark UI dialog overlay), mirrored from @cloudvoyant/vertex-react -->
<script lang="ts">
  import {
    Root,
    DialogBackdrop,
