...
export const numberInputStepperBase = 'flex w-9 shrink-0 flex-col border-s border-input';
export const numberInputButtonBase =
  'flex cursor-pointer items-center justify-center text-muted-foreground transition-colors hover:bg-accent hover:text-foreground disabled:pointer-events-none disabled:opacity-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring [&_svg]:pointer-events-none [&_svg]:size-3.5 [&_svg]:shrink-0';
export const numberInputIncrementBase = 'flex-1 border-b border-input';
export const numberInputDecrementBase = 'flex-1';
