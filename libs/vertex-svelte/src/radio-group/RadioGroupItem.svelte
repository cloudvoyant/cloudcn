<!-- libs/vertex-svelte/src/radio-group/RadioGroupItem.svelte -->
<!-- Closely based on: Shark UI radio group (@ark-ui/svelte/radio-group), mirrored from @cloudvoyant/vertex-react -->
<script lang="ts">
  import {
  ...
  import { radioGroupItemControlBase, radioGroupItemTextBase, cn } from '@cloudvoyant/vertex-ui';
