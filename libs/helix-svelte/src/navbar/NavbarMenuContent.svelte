<!-- libs/helix-svelte/src/navbar/NavbarMenuContent.svelte -->
...
<script lang="ts">
  ...
  const classes = $derived(cn(navbarMenuContentBase, className));
  setNavbarMenuStyle({ density: 'relaxed', variant: 'default', inContent: true });
</script>
