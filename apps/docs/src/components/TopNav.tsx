...
// The docs site top navigation, built from the helix Navbar (shrink variant).
import {
  Navbar,
  NavbarProvider,
  NavbarBrand,
...
import { HelixLogo } from './examples/HelixLogo';
    ...
    <NavbarProvider>
      ...
      >
        ...
        <NavbarActions>
          ...
          <ThemeSelector />
          <a
            href="https://github.com/cloudvoyant/helix"
            aria-label="GitHub"
