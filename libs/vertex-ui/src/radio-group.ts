// libs/vertex-ui/src/radio-group.ts
// Closely based on: Shark UI radio group (@ark-ui/react/radio-group).

export const radioGroupRootBase = 'flex flex-col gap-2';

export const radioGroupItemControlBase =
...
export const radioGroupItemTextBase = 'select-none text-sm font-medium leading-none';
