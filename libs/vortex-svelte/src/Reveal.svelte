<!-- libs/vortex-svelte/src/Reveal.svelte -->
<!-- Closely based on: diffbook QA (packages/diffbook-ui/src/components/QA.tsx), renamed Reveal,
     rebuilt on Ark UI Collapsible, mirrored from @cloudvoyant/vortex-react -->
<script lang="ts">
  import { CollapsibleRoot, CollapsibleTrigger, CollapsibleContent } from '@ark-ui/svelte/collapsible';
  import { revealRootBase, revealTriggerBase, revealChevronBase, revealContentBase, cn } from '@cloudvoyant/vortex-ui';
