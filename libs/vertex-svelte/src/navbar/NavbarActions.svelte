<!-- libs/vertex-svelte/src/navbar/NavbarActions.svelte -->
<!-- Source: @cloudvoyant/vertex-react navbar actions (shadcnblocks navbar6/7, re-based on Ark UI) -->
<script lang="ts">
  import { Ark } from '@ark-ui/svelte/factory';
  import { navbarActionsBase, cn } from '@cloudvoyant/vertex-ui';
