// libs/helix-react/src/card/cover.tsx
// Closely based on: Chakra UI Card, built on @ark-ui/react/factory (Ark UI)
import { ark, type HTMLArkProps } from '@ark-ui/react/factory';
import { cardCoverVariants, cn } from '@cloudvoyant/helix';
import type { CardCoverProps as CardCoverBaseProps } from '@cloudvoyant/helix';
