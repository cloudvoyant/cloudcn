// libs/vortex-svelte/src/navbar/NavbarMenuContext.svelte.ts
...
import type { NavbarMenuDensity, NavbarMenuVariant } from '@cloudvoyant/vortex-ui';
...
const NAVBAR_MENU_STYLE_KEY = Symbol('vortex-ui.navbar-menu.style');
