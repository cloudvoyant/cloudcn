<!-- libs/vertex-svelte/src/select/SelectNative.svelte -->
<!-- Closely based on: Shark UI native-select (@ark-ui/svelte/factory), mirrored from @cloudvoyant/vertex-react -->
<script lang="ts">
  import { Ark } from '@ark-ui/svelte/factory';
  import { nativeSelectVariants, nativeSelectWrapperBase, nativeSelectIconBase, cn } from '@cloudvoyant/vertex-ui';
  import type { SelectItemData } from '@cloudvoyant/vertex-ui';
