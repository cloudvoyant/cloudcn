<!-- libs/vortex-svelte/src/LaTeX.svelte -->
<!-- Closely based on: diffbook's KaTeX pipeline; block component, mirrored from @cloudvoyant/vortex-react -->
<script lang="ts">
  import { Ark } from '@ark-ui/svelte/factory';
  import { latexRootBase, latexDisplayBase, latexErrorBase, toLaTeX, cn } from '@cloudvoyant/vortex-ui';
