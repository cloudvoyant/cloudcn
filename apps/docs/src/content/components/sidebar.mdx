...
No theme extension is required — the sidebar uses the `--sidebar-*` tokens already shipped in `@cloudvoyant/vortex-ui`'s `theme.css` (light and dark).
