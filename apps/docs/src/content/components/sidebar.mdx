...
No theme extension is required — the sidebar uses the `--sidebar-*` tokens already shipped in `@cloudvoyant/vertex-ui`'s `theme.css` (light and dark).
