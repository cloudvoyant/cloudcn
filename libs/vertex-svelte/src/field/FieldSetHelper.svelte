<!-- libs/vertex-svelte/src/field/FieldSetHelper.svelte -->
<!-- Closely based on: Shark UI field (@ark-ui/svelte/fieldset), mirrored from @cloudvoyant/vertex-react -->
<script lang="ts">
  import { FieldsetHelperText, type FieldsetHelperTextProps } from '@ark-ui/svelte/fieldset';
  import { fieldsetHelperBase, cn } from '@cloudvoyant/vertex-ui';
