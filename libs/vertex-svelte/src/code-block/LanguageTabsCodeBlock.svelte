<!-- libs/vertex-svelte/src/code-block/LanguageTabsCodeBlock.svelte -->
<!-- Closely based on: diffbook code-block family, rebuilt with a vertex-ui Select language dropdown
     + floating copy, mirrored from @cloudvoyant/vertex-react -->
<script lang="ts">
  ...
  import type { LanguageTab } from '@cloudvoyant/vertex-ui';
