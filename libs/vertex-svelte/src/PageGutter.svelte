<!-- libs/vertex-svelte/src/PageGutter.svelte -->
<!-- No upstream component; composed from @cloudvoyant/vertex-ui page classes, mirrored from @cloudvoyant/vertex-react -->
<script lang="ts">
  import { Ark } from '@ark-ui/svelte/factory';
  import { pageGutterAreaBase, pageGutterVariants, pageGutterContentVariants, cn } from '@cloudvoyant/vertex-ui';
