<!-- libs/vortex-svelte/src/navbar/NavbarActivationArea.svelte -->
<!-- Source: @cloudvoyant/vortex-react navbar activation area (hover reveal for variant="hide") -->
<script lang="ts">
  import { Ark } from '@ark-ui/svelte/factory';
  import { navbarActivationAreaBase, cn } from '@cloudvoyant/vortex-ui';
