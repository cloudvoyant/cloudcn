<!-- libs/vortex-svelte/src/navbar/NavbarBrand.svelte -->
<!-- Source: @cloudvoyant/vortex-react navbar brand (shadcnblocks navbar6/7, re-based on Ark UI) -->
<script lang="ts">
  import { Ark } from '@ark-ui/svelte/factory';
  import { navbarBrandBase, cn } from '@cloudvoyant/vortex-ui';
