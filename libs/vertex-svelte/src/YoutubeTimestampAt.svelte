<!-- libs/vertex-svelte/src/YoutubeTimestampAt.svelte -->
<script lang="ts">
  import { Ark } from '@ark-ui/svelte/factory';
  import { getContext } from 'svelte';
  import { youtubeChapterButtonBase, youtubeChapterTimeBase, youtubeChapterLabelBase, formatTime } from '@cloudvoyant/vertex-ui';
  ...
  const ctx = getContext<{ seek: (t: number) => void }>('vertex-ui-youtube');
</script>
