// apps/wicn-docs/src/components/examples/sidebar/WicnLogo.tsx
// Inlined wicn mark so it inherits the current text color (theme accent).
export function WicnLogo({ className }: { className?: string }) {
  return (
