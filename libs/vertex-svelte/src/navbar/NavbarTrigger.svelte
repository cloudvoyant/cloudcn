<!-- libs/vertex-svelte/src/navbar/NavbarTrigger.svelte -->
<!-- Source: @cloudvoyant/vertex-react navbar trigger (shadcnblocks navbar6/7, re-based on Ark UI collapsible) -->
<script lang="ts">
  import { navbarTriggerVariants, cn } from '@cloudvoyant/vertex-ui';
