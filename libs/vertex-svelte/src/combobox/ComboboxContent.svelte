<!-- libs/vertex-svelte/src/combobox/ComboboxContent.svelte -->
<!-- Closely based on: Shark UI combobox (@ark-ui/svelte/combobox), mirrored from @cloudvoyant/vertex-react -->
<script lang="ts">
  import { Portal } from '@ark-ui/svelte/portal';
  import { ComboboxPositioner, ComboboxContent, type ComboboxContentProps } from '@ark-ui/svelte/combobox';
  import { comboboxContentBase, comboboxPositionerBase, cn } from '@cloudvoyant/vertex-ui';
