<!-- libs/vertex-svelte/src/field/FieldRequiredIndicator.svelte -->
<!-- Closely based on: Shark UI field (@ark-ui/svelte/field), mirrored from @cloudvoyant/vertex-react -->
<script lang="ts">
  import { FieldRequiredIndicator, type FieldRequiredIndicatorProps } from '@ark-ui/svelte/field';
  import { fieldRequiredIndicatorBase, cn } from '@cloudvoyant/vertex-ui';
