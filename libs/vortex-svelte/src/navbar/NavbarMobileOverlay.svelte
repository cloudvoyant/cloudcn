<!-- libs/vortex-svelte/src/navbar/NavbarMobileOverlay.svelte -->
<!-- Source: @cloudvoyant/vortex-react navbar mobile (Ark UI dialog overlay), mirrored from @cloudvoyant/vortex-react -->
<script lang="ts">
  import {
    Root,
    DialogBackdrop,
