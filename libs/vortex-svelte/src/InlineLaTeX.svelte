<!-- libs/vortex-svelte/src/InlineLaTeX.svelte -->
<!-- Inline LaTeX equation (displayMode: false), mirrored from @cloudvoyant/vortex-react -->
<script lang="ts">
  import { Ark } from '@ark-ui/svelte/factory';
  import { latexRootBase, latexInlineBase, latexErrorBase, toLaTeX, cn } from '@cloudvoyant/vortex-ui';
