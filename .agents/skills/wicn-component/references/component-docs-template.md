...
Every component page in `apps/wicn-docs/src/content/components/{component}.mdx` follows this anatomy. Write each paragraph as one continuous line; newlines only separate paragraphs, list items, headings, and code fences.
