<!-- libs/vortex-svelte/src/tags-input/TagInputItemDeleteTrigger.svelte -->
<!-- Closely based on: Shark UI tags input (@ark-ui/svelte/tags-input), mirrored from @cloudvoyant/vortex-react -->
<script lang="ts">
  import { TagsInputItemDeleteTrigger, type TagsInputItemDeleteTriggerProps } from '@ark-ui/svelte/tags-input';
  import { tagsInputItemDeleteTriggerBase, cn } from '@cloudvoyant/vortex-ui';
