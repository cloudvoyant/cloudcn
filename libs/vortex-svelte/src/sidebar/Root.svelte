<!-- libs/vortex-svelte/src/Sidebar.svelte -->
<!-- Source: @ark-ui/svelte/drawer (Ark UI), mirrored from @cloudvoyant/vortex-react -->
<script lang="ts">
  import {
    DrawerRoot,
    DrawerBackdrop,
  ...
  import { SIDEBAR_WIDTH_MOBILE, sidebarStyles, cn } from '@cloudvoyant/vortex-ui';
