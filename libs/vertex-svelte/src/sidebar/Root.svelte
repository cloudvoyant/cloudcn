<!-- libs/vertex-svelte/src/Sidebar.svelte -->
<!-- Source: @ark-ui/svelte/drawer (Ark UI), mirrored from @cloudvoyant/vertex-react -->
<script lang="ts">
  import {
    DrawerRoot,
    DrawerBackdrop,
  ...
  import { SIDEBAR_WIDTH_MOBILE, sidebarStyles, cn } from '@cloudvoyant/vertex-ui';
