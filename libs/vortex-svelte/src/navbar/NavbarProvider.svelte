<!-- libs/vortex-svelte/src/navbar/NavbarProvider.svelte -->
<!-- Source: @cloudvoyant/vortex-react navbar provider (shadcnblocks navbar6/7, re-based on Ark UI) -->
...
<script lang="ts">
  ...
  let id = $state(`vortex-ui-navbar-${++navbarIdCounter}`);
