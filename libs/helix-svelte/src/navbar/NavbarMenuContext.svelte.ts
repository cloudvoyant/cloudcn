// libs/helix-svelte/src/navbar/NavbarMenuContext.svelte.ts
...
import type { NavbarMenuDensity, NavbarMenuVariant } from '@cloudvoyant/helix';
...
const NAVBAR_MENU_STYLE_KEY = Symbol('helix.navbar-menu.style');
