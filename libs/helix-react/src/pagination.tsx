// libs/helix-react/src/pagination.tsx
...
import { paginationRootBase, paginationTriggerBase, paginationItemBase, paginationEllipsisBase, cn } from '@cloudvoyant/helix';
