// libs/wicn-svelte/src/navbar/NavbarMenuContext.svelte.ts
...
import type { NavbarMenuDensity, NavbarMenuVariant } from 'wicn-core';
...
const NAVBAR_MENU_STYLE_KEY = Symbol('wicn.navbar-menu.style');
