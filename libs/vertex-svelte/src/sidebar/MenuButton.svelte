<!-- libs/vertex-svelte/src/SidebarMenuButton.svelte -->
<!-- Source: @ark-ui/svelte/factory + tooltip (Ark UI), mirrored from @cloudvoyant/vertex-react -->
<script lang="ts">
  import { Ark } from '@ark-ui/svelte/factory';
  import { TooltipRoot, TooltipTrigger, TooltipPositioner, TooltipContent } from '@ark-ui/svelte/tooltip';
  import { sidebarMenuButtonVariants, sidebarStyles, cn } from '@cloudvoyant/vertex-ui';
