<!-- libs/vertex-svelte/src/dialog/DialogContent.svelte -->
<!-- Closely based on: Ark UI dialog (@ark-ui/svelte/dialog), mirrored from @cloudvoyant/vertex-react -->
<script lang="ts">
  import { Portal } from '@ark-ui/svelte/portal';
  import { Positioner as DialogPositioner, DialogContent, type DialogContentProps } from '@ark-ui/svelte/dialog';
  import { dialogPositionerBase, dialogContentBase, dialogFullscreenContentBase, cn } from '@cloudvoyant/vertex-ui';
