<!-- libs/vertex-svelte/src/select/SelectItem.svelte -->
<!-- Closely based on: Shark UI select (@ark-ui/svelte/select), mirrored from @cloudvoyant/vertex-react -->
...
<script lang="ts">
  ...
  import { selectItemBase, cn } from '@cloudvoyant/vertex-ui';
