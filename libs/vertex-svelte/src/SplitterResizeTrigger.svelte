<!-- libs/vertex-svelte/src/SplitterResizeTrigger.svelte -->
<!-- Closely based on: @ark-ui/svelte/splitter (Ark UI), Chakra UI Splitter, mirrored from @cloudvoyant/vertex-react -->
<script lang="ts">
  import { SplitterResizeTrigger, type SplitterResizeTriggerProps } from '@ark-ui/svelte/splitter';
  import { splitterResizeTriggerBase, splitterResizeTriggerSeparatorBase, cn } from '@cloudvoyant/vertex-ui';
