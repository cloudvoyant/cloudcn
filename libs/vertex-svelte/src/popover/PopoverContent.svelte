<!-- libs/vertex-svelte/src/popover/PopoverContent.svelte -->
<!-- Closely based on: Ark UI popover (@ark-ui/svelte/popover), mirrored from @cloudvoyant/vertex-react -->
<script lang="ts">
  ...
  import { popoverPositionerBase, popoverArrowBase, popoverContentBase, cn } from '@cloudvoyant/vertex-ui';
