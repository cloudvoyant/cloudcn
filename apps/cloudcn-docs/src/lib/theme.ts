...
// Ported from diffbook; localStorage keys use the cloudcn: namespace and all
// document/localStorage access is guarded for SSR safety.
import { THEME_NAMES } from 'cloudcn-core';

export const COLOR_MODE_KEY = 'cloudcn:color-mode' as const;
export const THEME_KEY = 'cloudcn:theme' as const;
export type ColorMode = 'light' | 'dark' | 'system';
export type ThemeName = string; // any cloudcn theme name — see cloudcn-core THEMES
