<!-- libs/vortex-svelte/src/select/SelectItemGroupLabel.svelte -->
<!-- Closely based on: Shark UI select (@ark-ui/svelte/select), mirrored from @cloudvoyant/vortex-react -->
<script lang="ts">
  import { SelectItemGroupLabel, type SelectItemGroupLabelProps } from '@ark-ui/svelte/select';
  import { selectItemGroupLabelBase, cn } from '@cloudvoyant/vortex-ui';
