<!-- libs/vortex-svelte/src/SplitterResizeTrigger.svelte -->
<!-- Closely based on: @ark-ui/svelte/splitter (Ark UI), Chakra UI Splitter, mirrored from @cloudvoyant/vortex-react -->
<script lang="ts">
  import { SplitterResizeTrigger, type SplitterResizeTriggerProps } from '@ark-ui/svelte/splitter';
  import { splitterResizeTriggerBase, splitterResizeTriggerSeparatorBase, cn } from '@cloudvoyant/vortex-ui';
