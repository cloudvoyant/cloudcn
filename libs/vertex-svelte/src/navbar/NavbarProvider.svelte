<!-- libs/vertex-svelte/src/navbar/NavbarProvider.svelte -->
<!-- Source: @cloudvoyant/vertex-react navbar provider (shadcnblocks navbar6/7, re-based on Ark UI) -->
...
<script lang="ts">
  ...
  let id = $state(`vertex-ui-navbar-${++navbarIdCounter}`);
