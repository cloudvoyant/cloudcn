<!-- libs/vertex-svelte/src/tags-input/TagInputItemDeleteTrigger.svelte -->
<!-- Closely based on: Shark UI tags input (@ark-ui/svelte/tags-input), mirrored from @cloudvoyant/vertex-react -->
<script lang="ts">
  import { TagsInputItemDeleteTrigger, type TagsInputItemDeleteTriggerProps } from '@ark-ui/svelte/tags-input';
  import { tagsInputItemDeleteTriggerBase, cn } from '@cloudvoyant/vertex-ui';
