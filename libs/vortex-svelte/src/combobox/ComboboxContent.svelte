<!-- libs/vortex-svelte/src/combobox/ComboboxContent.svelte -->
<!-- Closely based on: Shark UI combobox (@ark-ui/svelte/combobox), mirrored from @cloudvoyant/vortex-react -->
<script lang="ts">
  import { Portal } from '@ark-ui/svelte/portal';
  import { ComboboxPositioner, ComboboxContent, type ComboboxContentProps } from '@ark-ui/svelte/combobox';
  import { comboboxContentBase, comboboxPositionerBase, cn } from '@cloudvoyant/vortex-ui';
