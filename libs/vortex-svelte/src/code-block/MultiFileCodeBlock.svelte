<!-- libs/vortex-svelte/src/code-block/MultiFileCodeBlock.svelte -->
<!-- Closely based on: diffbook code-block family, mirrored from @cloudvoyant/vortex-react -->
<script lang="ts">
  import { Ark } from '@ark-ui/svelte/factory';
  import CopyButton from '../CopyButton.svelte';
  import CodeRenderer from './CodeRenderer.svelte';
  import { codeBlockRootBase, cn } from '@cloudvoyant/vortex-ui';
  import type { FileEntry } from '@cloudvoyant/vortex-ui';
