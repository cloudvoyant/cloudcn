// libs/helix-svelte/src/navbar/NavbarContext.svelte.ts
// Source: @cloudvoyant/helix-react navbar context (shadcnblocks navbar6/7, re-based on Ark UI)
...
export const NAVBAR_CONTEXT_KEY = Symbol('helix.navbar');
