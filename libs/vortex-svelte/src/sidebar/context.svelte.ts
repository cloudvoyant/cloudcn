// libs/vortex-svelte/src/sidebar/context.svelte.ts
// Source: @cloudvoyant/vortex-react sidebar context (shadcn/ui sidebar, re-based on Ark UI)
import { getContext, setContext } from 'svelte';
import type { SidebarContextProps } from '@cloudvoyant/vortex-ui';

export const SIDEBAR_CONTEXT_KEY = Symbol('vortex-ui.sidebar');
