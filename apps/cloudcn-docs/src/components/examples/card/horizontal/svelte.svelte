<!-- apps/cloudcn-docs/src/components/examples/card/horizontal/svelte.svelte -->
<script lang="ts">
  import { CardRoot, CardHeader, CardBody, CardTitle, CardDescription, CardCover } from 'cloudcn-svelte';
  import { User } from 'lucide-svelte';
</script>

<CardRoot orientation="horizontal" class="w-full max-w-2xl">
