<!-- libs/vortex-svelte/src/navbar/NavbarTrigger.svelte -->
<!-- Source: @cloudvoyant/vortex-react navbar trigger (shadcnblocks navbar6/7, re-based on Ark UI collapsible) -->
<script lang="ts">
  import { navbarTriggerVariants, cn } from '@cloudvoyant/vortex-ui';
