// libs/vortex-svelte/src/navbar/NavbarContext.svelte.ts
// Source: @cloudvoyant/vortex-react navbar context (shadcnblocks navbar6/7, re-based on Ark UI)
import { getContext, setContext } from 'svelte';
import type { Snippet } from 'svelte';
import type { NavbarDensity, NavbarVariant } from '@cloudvoyant/vortex-ui';
...
export const NAVBAR_CONTEXT_KEY = Symbol('vortex-ui.navbar');
